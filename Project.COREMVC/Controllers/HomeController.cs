    ...
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> Register(UserRegisterModel model)
        {
            ...
            if (result.Succeeded)
            {
                ...
                string body = $"Hesabýnýz olusturulmustur...Üyeligini onaylamak icin lütfen http://localhost:5217/Home/ConfirmEmail?specId={specId}&id={appUser.Id} linkine týklayýnýz";
