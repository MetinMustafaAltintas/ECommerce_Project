...
namespace Project.COREMVC.Controllers
{
    public class ShoppingController : Controller
    {
        ...
        public ShoppingController(IProductManager productManager, ICategoryManager categoryManager, IOrderDetailManager orderDetailManager, IOrderManager orderManager, UserManager<AppUser> userManager , IHttpClientFactory httpClientFactory)
        {
        ...
        //List<Product> List koleksiyon tipi Front End'e sayfalama yapmaya uygun bir koleksiyon degildir...

        // Shopping/Index?page=1 & categoryID = 2
